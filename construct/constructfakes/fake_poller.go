...
func (fake *FakePoller) Poll(arg1 time.Duration, arg2 func() (bool, error)) error {
	fake.pollMutex.Lock()
...
func (fake *FakePoller) PollCalls(stub func(time.Duration, func() (bool, error)) error) {
	fake.pollMutex.Lock()
	defer fake.pollMutex.Unlock()
	fake.PollStub = stub
}

func (fake *FakePoller) PollArgsForCall(i int) (time.Duration, func() (bool, error)) {
	fake.pollMutex.RLock()
	defer fake.pollMutex.RUnlock()
...
func (fake *FakePoller) PollReturnsOnCall(i int, result1 error) {
	fake.pollMutex.Lock()
	defer fake.pollMutex.Unlock()
	fake.PollStub = nil
...
func (fake *FakePoller) Invocations() map[string][][]interface{} {
...
func (fake *FakePoller) recordInvocation(key string, args []interface{}) {
...
var _ construct.Poller = new(FakePoller)
