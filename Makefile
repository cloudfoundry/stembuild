...
integration : generate-fake-stemcell-automation
	go run github.com/onsi/ginkgo/v2/ginkgo -r -vv --json-report="report.json" --keep-separate-reports --randomize-all --keep-going --flake-attempts 2 --timeout 3h integration
